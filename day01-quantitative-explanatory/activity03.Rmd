...
- Assign this data set into a data frame named `hfi` (short for "Human Freedom Index"). IGNORE THIS ABOVE NOTE
...
```{r explore-data}
skim(hfi_2016)
hfi_2016 <- hfi_2016 %>% select(pf_score,pf_expression_control,pf_ss_homicide)
hfi_2016
